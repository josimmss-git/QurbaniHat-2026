  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-10 flex flex-col ">
      ...
      <div>
        ...
        <div className='h-125 border-2 flex flex-wrap gap-4 justify-center items-start'>
      ...
      <div>
        ...
        <div>
          ...
          <p>Compare the animal's weight and physical condition before making a booking.</p>
